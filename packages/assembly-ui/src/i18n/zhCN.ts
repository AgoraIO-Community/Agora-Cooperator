const messages = {
  ...
  'modal.request.control.title': '请求控制',
  'message.disable.audio.title': '关闭麦克风',
  'message.disable.video.title': '关闭摄像头',
  'message.disable.screenShare.title': '停止屏幕共享',
  'message.invite.audio.request': '你已邀请 {username} 打开麦克风',
  'message.invite.video.request': '你已邀请 {username} 打开摄像头',
